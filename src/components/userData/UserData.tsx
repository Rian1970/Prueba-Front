    ...
    return (
      <main>
        <form className='user-data' onSubmit={handleSubmit}>
            ...
            <div>
                <label htmlFor="name">
                    <img src="public/UserData/person-svgrepo-com.svg" alt="person" />
                    Nombre
                </label>
                <input 
                    type="text" 
            ...
            <div className='input-edad'>
                <label htmlFor="age">
                    <img src="public/UserData/birthday-cake-celebration-festival-party-svgrepo-com.svg" alt="birthday" />
                    Edad
                </label>
                <input 
                    type="text" 
            ...
            <div>
                <label htmlFor="mail">
                    <img src="public/UserData/mail-svgrepo-com.svg" alt="mail" />
                    Correo electrónico
                </label>
                <input 
                    type="text" 
            ...
            <div className='input-telefono'>
                <label htmlFor="phone">
                    <img src="public/UserData/smartphone-svgrepo-com.svg" alt="smartphone" />
                    Teléfono celular
                </label>
                <input 
                    type="text" 
            ...
            <div>
                <label htmlFor="job">
                    <img src="public/UserData/location-pin-alt-1-svgrepo-com.svg" alt="location" />
                    Lugar de trabajo
                </label>
                <input 
                    type="text" 
